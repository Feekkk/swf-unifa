...
<body>
        ...
        <div class="container">
            ...
            <div id="navbarMenu" class="navbar-menu">
                <div class="navbar-start">
                    <a class="navbar-item is-active" href="/committee/dashboard">Dashboard</a>
                </div>
    ...
    <section class="section" style="padding-top:6rem">
        <div class="container">
            <h1 class="title is-3">Committee Dashboard</h1>
            <p class="subtitle is-6">Welcome, {{ Auth::guard('committee')->user()->name ?? 'Committee Member' }}</p>
                        ...
                        <div class="card-content">
                            ...
                            <div class="columns is-multiline is-mobile">
                                <div class="column is-12">
                                    ...
                                    <p class="is-size-6">{{ $committee->name ?? '-' }}</p>
                                </div>
                                <div class="column is-12">
                                    <p class="is-size-7" style="color:#000">Email</p>
                                    <p class="is-size-6">{{ $committee->email ?? '-' }}</p>
                                </div>
                                <div class="column is-12">
                                    <p class="is-size-7" style="color:#000">Role</p>
                                    <p class="is-size-6">
                                        <span class="tag is-info">Committee Member</span>
                                    </p>
                                </div>
                                <div class="column is-12">
