...
<head>
    ...
    <title>Application Details - Committee - RCMP Unifa</title>
        ...
        <div class="container">
            <div class="level mb-5">
                ...
                <div class="level-right">
                    <a href="{{ route('committee.applications.index') }}" class="button is-light">
                ...
                <div class="card-content">
                    ...
                    <div class="content">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">{{ $application->verifier->name ?? $application->verifier->email }}</div>
                        </div>
                        <div class="info-row">
                            <div class="info-label">Verified On</div>
                            <div class="info-value">{{ $application->updated_at->format('d M Y, g:i A') }}</div>
                        </div>
                        @endif
