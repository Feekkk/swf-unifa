...
<head>
    ...
    <title>View Applications - Committee - RCMP Unifa</title>
    ...
    <style>
        ...
        .button.is-primary.is-light{background-color:var(--primary); color:#fff; border-color:var(--primary)}
...
<body>
        ...
        <div class="container">
            ...
            <div id="navbarMenu" class="navbar-menu">
                <div class="navbar-start">
                    ...
                    <a class="navbar-item is-active" href="{{ route('committee.applications.index') }}">View Applications</a>
                </div>
    ...
    <section class="section" style="padding-top:6rem">
        <div class="container">
            ...
            <form method="GET" action="{{ route('committee.applications.index') }}" class="card mb-4">
                <div class="card-content">
                    ...
                    <div class="mt-3" style="display:flex; gap:.5rem; justify-content:flex-end">
                        ...
                        <a href="{{ route('committee.applications.index') }}" class="button is-light">Reset</a>
                    </div>
                </div>
            </form>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($app->verifier)
                                            <div>
                                                <div class="has-text-weight-semibold">{{ $app->verifier->name }}</div>
                                                <div class="is-size-7 has-text-grey">{{ optional($app->updated_at)->toDateString() }}</div>
                                            </div>
                                        @else
            ...
            <div class="columns">
                ...
                <div class="column is-2">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('committee.applications.index') }}">View Applications</a></li>
